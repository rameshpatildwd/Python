...
def lambda_handler(event, context):
    try:
        ...
        if ip == "0.0.0.0" or ip == "0.0.0.0/0":
            return {
                "statusCode": 400,
                "body": json.dumps({"reply": "Security Concerns: Whitelisting '0.0.0.0/0' is not allowed!"})
            }
        ...
        message = f"Awesome! {username}\n,Your IP {ip} has been whitelisted in {url}'s SG!\n, You can start accessing."
